<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/caminPage.Master" CodeBehind="Teams.aspx.cs" Inherits="appwebcccmex.Teams" %>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body badge-outline-secondary text-dark">
                            ...
                            <div class="col-sm-12">
                                ...
                                <telerik:RadGrid ID="gridAlerta" runat="server" Width="100%" RenderMode="Lightweight" AllowAutomaticDeletes="false" AllowAutomaticInserts="false" BackColor="White"
                                    ...
                                    <MasterTableView AllowAutomaticInserts="false" NoDetailRecordsText="No se encontraron registros ..." AutoGenerateColumns="False"
                                        Caption="Equipos" ClientDataKeyNames="IdEquipo"
                                        CommandItemDisplay="Top" DataKeyNames="IdEquipo" Font-Size="12px">
                                        <NoRecordsTemplate>
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="IdEquipo" DataType="System.Int64" HeaderText="EQUIPO ID" Visible="true" />
                                            <telerik:GridBoundColumn DataField="Nombre" DataType="System.String" HeaderText="EQUIPO" Visible="true" />
                                            ...
                                            <telerik:GridBoundColumn DataField="Tag" DataType="System.String" HeaderText="TAG" Visible="true" />
                                            <telerik:GridBoundColumn DataField="Detalle" DataType="System.String" HeaderText="DETALLE" Visible="false" />
                                        </Columns>
                                        <EditFormSettings>
    ...
    <telerik:RadWindowManager ID="ManejadorRadWindow" runat="server" Animation="Resize" Skin="Bootstrap">
        <Windows>
            <telerik:RadWindow ID="VentanaRad" runat="server" Behaviors="Close,Move" Modal="true" VisibleStatusbar="false"
                NavigateUrl="~/modal_cccmex_equipos.aspx" Title="Gestiòn de Eventos">
            </telerik:RadWindow>
        </Windows>
