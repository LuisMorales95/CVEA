<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/caminPage.Master" CodeBehind="accumulated.aspx.cs" Inherits="appwebcccmex.accumulated" %>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body badge-outline-secondary text-dark">
                            <div class="form-group row">
                                <div class="col-sm-12">
                                    <label class="col-form-label col-sm-2" for="lblc">Mes</label>
                                    <div class=" col-sm-4">
                                        <div class="mb-3">
                                            <telerik:RadComboBox ID="cmbmes" runat="server" Skin="Bootstrap" CssClass="text-center" EmptyMessage="- Selecciona el mes -" Width="100%" MarkFirstMatch="true"></telerik:RadComboBox>
                                        </div>
                                        <div class="mb-3">
                                            <telerik:RadTextBox ID="addanio" runat="server" Skin="Bootstrap" Width="20%" Height="30px" MaxLength="4" EmptyMessage="Año" />
                                        </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class=" col-sm-7">
                                        <telerik:RadButton ID="rbproducto" runat="server" Skin="Bootstrap" Width="50%" ToggleType="CheckBox" ButtonType="LinkButton">
                                            <ToggleStates>
                                ...
                                <div class="col-sm-12 mb-3">
                                    <label class="col-form-label col-sm-2" for="lblc2">Acumulado</label>
                                    <div class=" col-sm-7">
                                        <telerik:RadButton ID="rbacumulado" runat="server" Skin="Bootstrap" Width="50%" ToggleType="CheckBox" ButtonType="LinkButton">
                                            <ToggleStates>
                                ...
                                <div class="col-sm-12">
                                    <div class="col-sm-7 ">
                                        <telerik:RadButton ID="cmdejecuta" runat="server" Skin="Material" RenderMode="Lightweight" Width="50%" Height="35px" Font-Bold="true" Font-Size="16px" Text="Realizar consulta" OnClick="cmdejecuta_Click" />
                                    </div>
                                </div>
                            </div>
                            <hr />
                            <div class="col-sm-12">
                                ...
                                <p>
                                    <telerik:RadGrid ID="gridServicio" runat="server" Skin="Material" RenderMode="Lightweight"
                                        AllowAutomaticDeletes="false" AllowAutomaticInserts="false" AllowAutomaticUpdates="false" AllowMultiRowSelection="false" AllowPaging="false" AllowSorting="false" Font-Size="12px" OnItemCommand="gridServicio_ItemCommand">
