<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/caminPage.Master" CodeBehind="adminbycenter.aspx.cs" Inherits="appwebcccmex.adminbycenter" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header text-github">
                            ADMINISTRACIÓN DE CENTROS CCC-MEX.
                        </div>
                        <div class="card-body badge-outline-secondary text-dark">
                            <div class="form-group row">
                                <%-- each item --%>
                                <div class="col-sm-12">
                                    <telerik:RadPanelBar ID="RadPanelBar1" runat="server" Skin="Bootstrap" ExpandMode="MultipleExpandedItems" Width="100%">
                                        <Items>
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="border-spacing: 5px; border-collapse: separate; text-align: left; margin: auto; font-size: 16px; width: 90%;">
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadComboBox ID="cmbcentro" runat="server" Skin="Bootstrap" AutoPostBack="true" EmptyMessage="- Seleccione el centro -" Width="410px" MarkFirstMatch="true"></telerik:RadComboBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadComboBox ID="cmbproducto" runat="server" Skin="Bootstrap"  AutoPostBack="true" EmptyMessage="- Seleccione el producto -" Width="410px" MarkFirstMatch="true"></telerik:RadComboBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadComboBox ID="cmbservicio" runat="server" Skin="Bootstrap" AutoPostBack="true" EmptyMessage="- Seleccione el servicio -" Width="410px" MarkFirstMatch="true"></telerik:RadComboBox>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtDefault" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtRevisado" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <br />
                                                                        <telerik:RadButton ID="rbtTramite" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtCancel" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtaceptadopag" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton02">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtarechazadopag" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton02">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtnBarco" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton02">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadDatePicker ID="rdpFechaIni" runat="server" Skin="Bootstrap" AutoPostBack="true"
                                                                        ...
                                                                        <telerik:RadDatePicker ID="rdpFechaFin" runat="server" Skin="Bootstrap" AutoPostBack="true"
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtAnio" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton03">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtAniomes" runat="server" Width="45%" Skin="Bootstrap" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton03">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" style="text-align: right;">
                                                                        <telerik:RadButton ID="cmdreset" runat="server" Width="45%" Skin="Material" RenderMode="Lightweight" Height="35px" Font-Bold="true" Font-Size="16px" Text="Resetear parametros" OnClientClicking="RadConfirm" OnClick="cmdreset_Click" />
                                                                        <telerik:RadButton ID="cmdejecuta" runat="server" Width="45%" Skin="Material" RenderMode="Lightweight" Height="35px" Font-Bold="true" Font-Size="16px" Text="Realizar consulta" OnClick="cmdejecuta_Click" />
                            ...
                            <div class="col-sm-12">
                                <telerik:RadGrid ID="gridCapturas" runat="server" Skin="Material" RenderMode="Lightweight" AllowAutomaticDeletes="false" AllowAutomaticInserts="false" AllowAutomaticUpdates="false" AllowMultiRowSelection="false" AllowPaging="True" AllowSorting="false" OnItemCommand="gridCapturas_ItemCommand" OnNeedDataSource="gridCapturas_NeedDataSource" PageSize="10">
                                    ...
                                    <MasterTableView AllowAutomaticInserts="false" NoDetailRecordsText="No se encontraron registros ..." AutoGenerateColumns="False" Caption="CAPTURAS" ClientDataKeyNames="IdReg,IdProducto,IdCentro,IdInst,IdServicio,IdBarco,Folio_cert_calidad,Folio_cert_cant,Referencia_folio" CommandItemDisplay="Top" DataKeyNames="IdReg" Font-Size="11px">
                                        ...
                                        <CommandItemTemplate>
                                            ...
                                            <telerik:RadToolBar ID="RadToolBar1" runat="server" Skin="Material" RenderMode="Lightweight" AutoPostBack="true">
                                                <Items>
                                                    <telerik:RadToolBarButton CommandName="updateGrid" ImageUrl="Images/Update.png" Text="ACTUALIZA REGISTROS">
                                        ...
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="NombreBarco" DataType="System.String" HeaderText="IDBARCO" Visible="false" />
                                            ...
                                            <telerik:GridBoundColumn DataField="NombreBarco" DataType="System.String" HeaderText="BARCO" />
                                            ...
                                            <telerik:GridBoundColumn DataField="Comentarios" DataType="System.String" HeaderText="CMT." Visible="true" />
