<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cccmex_acumulados.aspx.cs" Inherits="appwebcccmex.cccmex_acumulados" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
        <hgroup class="title">
            <h1>Acumuldos Por Mes</h1>
        </hgroup>

        <fieldset>
            <ol>
                <li>
                    <asp:Label ID="lblCentro" runat="server" Font-Bold="true" Font-Size="14px" Text="Mes: "></asp:Label><br />
                    <telerik:RadComboBox ID="cmbmes" runat="server" EmptyMessage="- Selecciona el mes -" Width="250px" MarkFirstMatch="true"></telerik:RadComboBox>
                    <telerik:RadTextBox ID="addanio" runat="server" Width="8%" Height="30px" MaxLength="4" EmptyMessage="Año" />
                </li>
