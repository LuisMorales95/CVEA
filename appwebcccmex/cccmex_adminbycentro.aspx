<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cccmex_adminbycentro.aspx.cs" Inherits="appwebcccmex.cccmex_adminbycentro" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
     <hgroup class="title">
        <h1>ADMINISTRACIÓN DE CENTROS CCC-MEX.</h1>       
    </hgroup>
                                     ...
                                     <ItemTemplate>
                                         <table style="border-spacing:5px; border-collapse:separate; text-align:left; margin:auto; font-size:16px; width:90%;">
                                              ...
                                              <tr>
                                                 ...
                                                 <td>
                                                     <telerik:RadButton ID="rbtDefault" runat="server" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                        <ToggleStates>
