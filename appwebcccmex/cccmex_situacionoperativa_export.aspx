<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="cccmex_situacionoperativa_export.aspx.cs" Inherits="appwebcccmex.cccmex_situacionoperativa_export" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <telerik:RadAjaxPanel ID="RadAjaxPanel1" runat="server">
        <hgroup class="title">
            <h1>Situación Operativa de por centros de trabajo</h1>
        </hgroup>
        ...
        <p>
            <telerik:RadGrid ID="gridCapturas" runat="server"
