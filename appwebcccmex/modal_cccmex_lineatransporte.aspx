<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="modal_cccmex_lineatransporte.aspx.cs" Inherits="appwebcccmex.modal_cccmex_lineatransporte" %>
...
<head runat="server">
    ...
    <title>Gestión Linea de Transporte</title>
            ...
            <table width="300px">
                <tr>
                    <td valign="top">
                        ...
                        <asp:Label runat="server" Text="Linea de Transporte" Font-Bold="True"></asp:Label><br />
                        <telerik:RadTextBox ID="txtLinea" runat="server" Skin="Bootstrap" Width="297px" align="center"></telerik:RadTextBox>
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtLinea" runat="server" ValidationGroup="get"></asp:RequiredFieldValidator>
                        <br />
