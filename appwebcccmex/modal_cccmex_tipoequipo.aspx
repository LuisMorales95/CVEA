<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="modal_cccmex_tipoequipo.aspx.cs" Inherits="appwebcccmex.modal_cccmex_tipoequipo" %>
...
<head runat="server">
    ...
    <title>Gestión Tipo de Equipo</title>
         ...
         <table width="300px" >
            <tr>
                <td valign="top" >
                    ...
                    <asp:Label Text="Codigo" runat="server" Font-Bold="true" />
                    <br />
                    <telerik:RadTextBox ID="txtCodigo" runat="server" Skin="Bootstrap" Width="297px" MaxLength="5" align="center"></telerik:RadTextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ControlToValidate="txtCodigo" runat="server" ValidationGroup="get"></asp:RequiredFieldValidator>   
                    <br />

                    <asp:Label runat="server" Text="Tipo Equipo" Font-Bold="True"/>
                    <br />
                    <telerik:RadTextBox ID="txtTipoEquipo" Runat="server" Skin="Bootstrap" Width="297px" MaxLength="20" align="center"></telerik:RadTextBox>
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtTipoEquipo" runat="server" ValidationGroup="get"></asp:RequiredFieldValidator>   
                    <br/>
                
                    <asp:Label runat="server" Text="Descripción" Font-Bold="True"></asp:Label><br />
                    <telerik:RadTextBox ID="txtDes" Runat="server" Skin="Bootstrap" Width="297px" MaxLength="100" align="center"></telerik:RadTextBox>
