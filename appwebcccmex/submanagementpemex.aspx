<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/caminPage.Master" CodeBehind="submanagementpemex.aspx.cs" Inherits="appwebcccmex.submanagementpemex" %>
                                                        ...
                                                        <ItemTemplate>
                                                            <table style="border-spacing: 5px; border-collapse: separate; text-align: left; margin: auto; font-size: 16px; width: 90%;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtDefault" runat="server" Skin="Bootstrap" Width="60%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtRevisado" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <br />
                                                                        <telerik:RadButton ID="rbtTramite" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtCancel" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtaceptadopag" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton02">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtarechazadopag" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton02">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtnBarco" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton02">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <telerik:RadButton ID="rbtAnio" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton03">
                                                                            <ToggleStates>
                                                                        ...
                                                                        <telerik:RadButton ID="rbtAniomes" runat="server" Skin="Bootstrap" Width="45%" ToggleType="Radio" ButtonType="LinkButton" GroupName="StandardButton03">
                                                                            <ToggleStates>
                                                                ...
                                                                <tr>
                                                                    <td colspan="2" style="text-align: right;">
                                                                        <telerik:RadButton ID="cmdreset" runat="server" Skin="Material" RenderMode="Lightweight" Width="45%" Height="35px" Font-Bold="true" Font-Size="16px" Text="Resetear parametros" OnClientClicking="RadConfirm" OnClick="cmdreset_Click" />
                                                                        <telerik:RadButton ID="cmdejecuta" runat="server" Skin="Material" RenderMode="Lightweight" Width="45%" Height="35px" Font-Bold="true" Font-Size="16px" Text="Realizar consulta" OnClick="cmdejecuta_Click" />
