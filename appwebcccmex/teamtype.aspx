<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/caminPage.Master" CodeBehind="teamtype.aspx.cs" Inherits="appwebcccmex.teamtype" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header text-github">
                            Gestión de Tipo Equipo
                        </div>
                        <div class="card-body badge-outline-secondary text-dark">

                            <div class="col-sm-12">
                                <telerik:RadGrid ID="gridAlerta" runat="server" Width="100%" AllowAutomaticDeletes="false" AllowAutomaticInserts="false" BackColor="White"
                                    AllowAutomaticUpdates="false" AllowMultiRowSelection="false" AllowPaging="True" AllowSorting="false"
                                    OnItemCommand="gridAlerta_ItemCommand" OnNeedDataSource="gridAlerta_NeedDataSource" PageSize="10"
                                    Skin="Material" RenderMode="Lightweight" ShowFooter="True">

                                    <MasterTableView AllowAutomaticInserts="false" NoDetailRecordsText="No se encontraron registros ..." AutoGenerateColumns="False"
                                        Caption="TipoEquipo" ClientDataKeyNames="IdTipoEquipo"
                                        CommandItemDisplay="Top" DataKeyNames="IdTipoEquipo" Font-Size="12px">
                                        <NoRecordsTemplate>
                                        ...
                                        <CommandItemTemplate>
                                            <telerik:RadToolBar ID="RadToolBar1" runat="server" AutoPostBack="true" EnableShadows="True" RenderMode="Lightweight" SingleClick="None" Skin="Material">
                                                <Items>
                                                    <telerik:RadToolBarButton runat="server" CommandName="btnAgregar" ImageUrl="~/Images/mas3.png" Text="Nuevo" ToolTip="Generar una nueva tipo.">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton runat="server" CommandName="btnActualizar" ImageUrl="~/Images/Update.png" Text="Actualizar" ToolTip="Actualizar un tipo existente.">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton runat="server" CommandName="btnEliminar" ImageUrl="~/Images/delete.png" Text="Eliminar" ToolTip="Eliminar una tipo existente.">
                                                    </telerik:RadToolBarButton>
                                                </Items>
                                            </telerik:RadToolBar>
                                        </CommandItemTemplate>
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="IdTipoEquipo" DataType="System.Int64" HeaderText="TIPO EQUIPO ID" Visible="true" />
                                            <telerik:GridBoundColumn DataField="Codigo" DataType="System.String" HeaderText="CODIGO" Visible="true" />
                                            <telerik:GridBoundColumn DataField="TipoEquipo" DataType="System.String" HeaderText="TIPO EQUIPO" Visible="true" />
    ...
    <telerik:RadWindowManager ID="ManejadorRadWindow" runat="server" Animation="Resize" Skin="Bootstrap">
        <Windows>
            <telerik:RadWindow ID="VentanaRad" runat="server" Behaviors="Close,Move" Modal="true" VisibleStatusbar="false"
                NavigateUrl="~/modal_cccmex_tipoequipo.aspx" Title="Gestión de Tipo Equipo">
            </telerik:RadWindow>
        </Windows>
