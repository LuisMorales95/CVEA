<%@ Page Title="" Language="C#" AutoEventWireup="true" MasterPageFile="~/caminPage.Master" CodeBehind="transportline.aspx.cs" Inherits="appwebcccmex.transportline" %>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header text-github">
                            Gestión de Linea Transporte
                        </div>
                        <div class="card-body badge-outline-secondary text-dark">

                            <div class="col-sm-12">

                                <telerik:RadGrid ID="gridAlerta" runat="server" RenderMode="Lightweight" Width="100%" AllowAutomaticDeletes="false" AllowAutomaticInserts="false" BackColor="White"
                                    ...
                                    <MasterTableView AllowAutomaticInserts="false" NoDetailRecordsText="No se encontraron registros ..." AutoGenerateColumns="False"
                                        Caption="Linea Transporte" ClientDataKeyNames="IdLineaTransporte"
                                        CommandItemDisplay="Top" DataKeyNames="IdLineaTransporte" Font-Size="12px">
                                        <NoRecordsTemplate>
                                        ...
                                        <CommandItemTemplate>
                                            <telerik:RadToolBar ID="RadToolBar1" runat="server" AutoPostBack="true" EnableShadows="True" RenderMode="Lightweight" SingleClick="None" Skin="Metro">
                                                <Items>
                                                    <telerik:RadToolBarButton runat="server" CommandName="btnAgregar" ImageUrl="~/Images/mas3.png" Text="Nuevo" ToolTip="Generar una nueva Linea Transporte.">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton runat="server" CommandName="btnActualizar" ImageUrl="~/Images/Update.png" Text="Actualizar" ToolTip="Actualizar una Linea Transporte existente.">
                                                    </telerik:RadToolBarButton>
                                                    <telerik:RadToolBarButton runat="server" CommandName="btnEliminar" ImageUrl="~/Images/delete.png" Text="Eliminar" ToolTip="Eliminar una Linea Transporte existente.">
                                                    </telerik:RadToolBarButton>
                                                </Items>
                                            </telerik:RadToolBar>
                                        </CommandItemTemplate>
                                        ...
                                        <Columns>
                                            <telerik:GridBoundColumn DataField="IdLineaTransporte" DataType="System.Int64" HeaderText="ID LINEA TRANSPORTE" Visible="true" />
                                            <telerik:GridBoundColumn DataField="LineaTransporte" DataType="System.String" HeaderText="LINEA TRANSPORTE" Visible="true" />
    ...
    <telerik:RadWindowManager ID="ManejadorRadWindow" runat="server" Animation="Resize" Skin="Bootstrap">
        <Windows>
            <telerik:RadWindow ID="VentanaRad" runat="server" Behaviors="Close,Move" Modal="true" VisibleStatusbar="false"
                NavigateUrl="~/modal_cccmex_lineatransporte.aspx" Title="Gestión de Linea Transporte">
            </telerik:RadWindow>
        </Windows>
